...
; I2C_RTC.asm
;
; Created: 10.11.2022. 23:08:53
; Author : Alex
;


/* Arduino Asembler, I2C RTC (Real Time Clock) */
...
write_rtc:
	...
	ldi twi_data, 0x10			// Upisuje dan u mesecu, npr 16.
	rcall twi_transfer
	rcall twi_stop
	;---------------------------------
	...
	ldi twi_data, 0x05			// Upisuje dan u nedelji, 01 = nedelja, npr 05 = cetvrtak
	rcall twi_transfer
	rcall twi_stop
	;---------------------------------
	...
	ldi twi_data, 0x23			// Upisuje 12 (AM/PM) / 24 sat
	rcall twi_transfer
	rcall twi_stop
	;---------------------------------
	// Minut (00 - 59)
	...
	ldi twi_data, 0x37			// Upisuje minute
	rcall twi_transfer
	rcall twi_stop
	;---------------------------------
	// Sekunda (00 - 59)
	...
	ldi twi_data, 0x15			// Upisuje sekunde
	rcall twi_transfer
	rcall twi_stop
	ret
// Kraj upisa
